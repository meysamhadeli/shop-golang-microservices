...
func Test_Parse_Error(t *testing.T) {
	...
	badRequestError := errors.Wrap(customErrors2.NewBadRequestError("bad-request error"), "bad request error")
	...
	notFoundError := customErrors2.NewNotFoundError("notfound error")
