...
func (c *productsModuleConfigurator) configProductsMediator(pgRepo contracts.ProductRepository) error {
	...
	err := mediatr.RegisterRequestHandler[*v17.CreateProduct, *create_dtos.CreateProductResponseDto](v17.NewCreateProductHandler(c.Log, c.Cfg, pgRepo, c.RabbitmqPublisher, c.GrpcClient))
	if err != nil {
		return err
	}
